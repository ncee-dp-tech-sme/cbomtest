...
pqc-smoke-java is a scalable audit framework built on Java / Spring Boot. It provides secure
...
```bash
mvn clean package
java -jar target/pqc-smoke-java-1.0.0.jar
```
...
Proprietary — pqc-smoke-java 1.0.0. All rights reserved.
