...
Webchat is a distributed notification service built on Java / Spring Boot. It provides secure
...
```bash
mvn clean package
java -jar target/Webchat-1.0.1a.jar
```
...
Proprietary — Webchat 1.0.1a. All rights reserved.
