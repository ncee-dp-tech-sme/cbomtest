"""
tests/test_factories_csharp.py

Snippet factory tests (SF-01..05) for C# weakness factories.
...
_FACTORIES = [
    (i, wk, fn)
    for i, (wk, fn) in enumerate(gva.CSHARP_WEAKNESS_FACTORIES)
]
_IDS = [f"cs[{i}]-{wk.tag}-{wk.description[:40]}" for i, wk, fn in _FACTORIES]
