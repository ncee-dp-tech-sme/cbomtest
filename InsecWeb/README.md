...
InsecWeb is a enterprise data gateway built on Java / Spring Boot. It provides secure
...
```bash
mvn clean package
java -jar target/InsecWeb-1.0.0.jar
```
...
Proprietary — InsecWeb 1.0.0. All rights reserved.
