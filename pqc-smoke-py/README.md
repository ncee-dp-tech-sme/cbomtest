...
pqc-smoke-py is a distributed identity platform built on Python / Flask. It provides secure
...
```bash
mvn clean package
java -jar target/pqc-smoke-py-1.0.0.jar
```
...
Proprietary — pqc-smoke-py 1.0.0. All rights reserved.
